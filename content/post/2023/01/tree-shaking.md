...
thumbnail: "/image/post/2023/01/tree-shaking/01.png"
---

# 용량을 절약하는 방법

![bundle_map](/image/post/2023/01/tree-shaking/01.png)
...
![tree-shaking](/image/post/2023/01/tree-shaking/02.gif)
...
![example-app](/image/post/2023/01/tree-shaking/03.png)
...
![bundle size before tree shaking](/image/post/2023/01/tree-shaking/04.png)

번들된 파일 두개를 다운받았고, 38.4KB, 21.6KB의 크기를 갖습니다. 객관적으로 가볍긴 하지만 여기서 굳이 트리 쉐이킹을 통해 용량을 더 줄여 보겠습니다.

## 필요한 것만 import하기

![analyzing scripts](/image/post/2023/01/tree-shaking/05.png)
...
![after tree shaking](/image/post/2023/01/tree-shaking/06.png)
